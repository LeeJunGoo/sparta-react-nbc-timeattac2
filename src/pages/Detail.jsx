...
import { getSingleTodoThunk } from "../features/todo/todoSlice";

const Detail = () => {
  const dispatch = useDispatch();
  const { todoId } = useParams();
  const [todo, setTodo] = useState("");
  dispatch(getSingleTodoThunk(todoId));
  ...
  return (
    <section>
      <TodoItem todo={todo} onDeleteTodoItem={handleDeleteTodoItem} onToggleTodoItem={handleToggleTodoItem} />
    </section>
  );
};
